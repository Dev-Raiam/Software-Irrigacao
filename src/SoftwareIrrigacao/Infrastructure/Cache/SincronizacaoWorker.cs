...
using Toolbox.Automacao.Sincronizacao.Services;
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                try
                {
                    ...
                    var serviceSincronizar =
                        scoped.ServiceProvider.GetRequiredService<Toolbox.Automacao.Sincronizacao.Services.SincronizarControladores>();
