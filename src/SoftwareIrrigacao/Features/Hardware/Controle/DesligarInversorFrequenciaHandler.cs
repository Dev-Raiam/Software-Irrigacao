...
public class DesligarInversorFrequenciaHandler : ICommandHandler<DesligarInversorFrequencia>
{
    private readonly IMqtt _mqtt;

    public DesligarInversorFrequenciaHandler([FromKeyedServices(Mqtt.Interno)] IMqtt mqtt)
    {
        _mqtt = mqtt;
    }
