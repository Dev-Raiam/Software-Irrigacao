...
public class DefinirFrequenciaInversorHandler : ICommandHandler<DefinirFrequenciaInversor>
{
    private readonly IMqtt _mqtt;

    public DefinirFrequenciaInversorHandler([FromKeyedServices("local")] IMqtt mqtt)
    {
        _mqtt = mqtt;
    }
    ...
    )
    {
        ...
        var comando = new ComandoControleAnalogico { Porta = "Q1", Valor = request.Frequencia };
