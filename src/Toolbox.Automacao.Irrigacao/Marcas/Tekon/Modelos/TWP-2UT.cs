...
namespace Toolbox.Automacao.Irrigacao.Marcas.Tekon.Modelos
{
    public class TWP_2UT
    {
        ...
        public float TemperaturaExterna_1 { get; private set; }
        public float TemperaturaExterna_2 { get; private set; }
        ...
        public TWP_2UT(ushort[] registradores)
        {
