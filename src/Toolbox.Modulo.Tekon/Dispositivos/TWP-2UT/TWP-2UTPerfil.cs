...
{
    internal class TWP_2UTPerfil : ITekonDispositivoPerfil
    {
        public string Modelo => Modelos.TWP_2UT;
        ...
        {
            throw new NotSupportedException("TWP-2UT não suporta leitura analógica");
        }
